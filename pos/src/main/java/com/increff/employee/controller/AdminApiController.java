...
import com.increff.employee.model.ChangePasswordForm;
...
public class AdminApiController {
	...
	@RequestMapping(path = "api/user", method = RequestMethod.PUT)
		public void changePassword(@RequestBody ChangePasswordForm form) throws ApiException {
			...
			if(pojo.getPassword()!= form.getPreviousPassword()){
				throw new ApiException("Previous password didn't matched");
			}
			else{
				service.changePassword(form.getEmail(), form.getCurrentPassword());
			}
		}
